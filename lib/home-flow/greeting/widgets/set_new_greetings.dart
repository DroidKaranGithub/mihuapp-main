...
class NewGreetingPage extends StatefulWidget {
  final RxList<TodayGreetingsCat> greetingTodayListPost;
  NewGreetingPage(this.greetingTodayListPost, {super.key});

  @override
  _NewGreetingPageState createState() => _NewGreetingPageState();
}

class _NewGreetingPageState extends State<NewGreetingPage> {
              ...
              child: InputDecorator(
                ...
                child: DropdownButtonHideUnderline(
                  child: DropdownButton<String>(
                    ...
                    isExpanded: true,
                    items: widget.greetingTodayListPost.map((category) {
